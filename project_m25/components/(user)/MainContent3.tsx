...
const MainContent3: React.FC = () => {
  ...
  // Trạng thái cho thông tin người nhận
        ...
        {products.length > 0 ? (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {products.map((product) => (
              <div
                key={product.id}
                className="relative border rounded-lg overflow-hidden shadow-md p-3 flex flex-col h-full items-center"
              >
                <img
                  src={product.image}
                ...
                <span className="text-center">From: ${product.unit_price}</span>
                <button
